...
import { FaEnvelope } from "react-icons/fa";  // ✅ Correct
            ...
            <div className='container mx-auto px-8 md:px-16 lg:px-24'>
                ...
                <div className='flex flex-col md:flex-row items-center md:space-x-12'>
                    ...
                    <div className='flex-1'>
                        ...
                        <p>
                            Feel free to reach out for any inquiries or collaborations – I'm open to discussing web development!
                        </p>
                        <div className='mb-4 mt-8'>
                            <FaEnvelope className='inline-block text-green-400 mr-2'></FaEnvelope>
                            <a href="mailto:irfanashfaq890@gmail.com" className='hover:underline'>
                                irfanashfaq890@gmail.com
                            </a>
                        ...
                        <div className='mb-4 '>
                            ...
                            <span>+923094846496</span>
                        </div>

                        <div className='mb-4 mt-8'>
                            <FaMapMarkedAlt className='inline-block text-green-400 mr-2'></FaMapMarkedAlt>
                            <span>Main Road Street No.4 Mahla Ali Park Kasure, Pakistan</span>
                        </div>
                    </div>
